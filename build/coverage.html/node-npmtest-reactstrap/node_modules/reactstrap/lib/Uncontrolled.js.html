...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-reactstrap/node_modules/reactstrap/lib/Uncontrolled.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-reactstrap/node_modules/reactstrap/lib/Uncontrolled.js</span></h1>
    <h2>
        
        Statements: <span class="metric">75% <small>(60 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-reactstrap/node_modules/reactstrap/lib/</a> &#187; Uncontrolled.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function Uncontrolled(props) {</span>
<span class="cstat-no" title="statement not covered" >      _classCallCheck(this, Uncontrolled);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _this = _possibleConstructorReturn(this, (Uncontrolled.__proto__ || Object.getPrototypeOf(Uncontrolled)).call(this, props));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _this.state = { isOpen: defaultValue };</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        this.setState({ isOpen: !this.state.isOpen });</span>
      }
    }, {
      key: 'render',
      value: <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement(Tag, _extends({ isOpen: this.state.isOpen, toggle: this.toggle }, this.props));</span>
      }
    }]);
&nbsp;
    return Uncontrolled;
