...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-reactstrap/node_modules/reactstrap/lib/TabContent.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-reactstrap/node_modules/reactstrap/lib/TabContent.js</span></h1>
    <h2>
        
        Statements: <span class="metric">65.22% <small>(45 / 69)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-reactstrap/node_modules/reactstrap/lib/</a> &#187; TabContent.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function TabContent(props) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, TabContent);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (TabContent.__proto__ || Object.getPrototypeOf(TabContent)).call(this, props));</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (this.state.activeTab !== nextProps.activeTab) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var classes = (0, _utils.mapToCssModules)((0, _classnames2.default)('tab-content', className), cssModule);</span>
&nbsp;
